...
public class CategoriaController {
	...
	// Método voltado a consulta por ID
	@GetMapping("/{id}")
	...
	// Método voltado a consulta por Nome da Categoria
	...
	// Método voltado para a criação de uma categoria
	@PostMapping
	...
	// Método voltado para atualizar uma categoria
    @PutMapping
    ...
    // Método voltado deletar uma categoria
	@DeleteMapping("/{id}")
